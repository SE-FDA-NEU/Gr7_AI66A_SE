...
| `/quiz/:id/questions` | Question & choice management | U | P0 | F3 | [#19](https://github.com/SE-FDA-NEU/Gr7_AI66A_SE/issues/19) | - | In progress |
| `/student/dashboard` | Student dashboard & quiz listing | U | P0 | F4 | [#35](https://github.com/SE-FDA-NEU/Gr7_AI66A_SE/issues/35) | - | In progress |
