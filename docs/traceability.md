...
| `/login` | User authentication & role separation | G | P0 | F9 | [#17](https://github.com/SE-FDA-NEU/Gr7_AI66A_SE/issues/17) | [#51](https://github.com/SE-FDA-NEU/Gr7_AI66A_SE/pull/51) | In progress |
# Business Rules
